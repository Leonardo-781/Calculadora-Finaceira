...
void capitalizacao_simples()
{
    ...
    printf("\n 4 - Calcular Taxa (i)");
    printf("\n 5 - Calcular Tempo (n)");
    printf("\n\t Qual conta de capitalizacao de quer fazer? ");
    printf("\n======================================================");
    scanf("%d", &operacao);
    switch (operacao)
    {
    case 1:
        ...
        scanf("%f", &n);
        vp = vf / (1.0 + (i / 100.0) * n);
        printf("\nO resultado do valor presente(VP) eh:  R$%.2f", vp);
        printf("\n");
        break;
    case 2:
        printf("\nEntre com os dados:");
        ...
        scanf("%f", &n);
        vf = vp * (1.0 + (i / 100.0) * n);
        printf("\n O resultado do valor do montante(VF) eh:  R$%.2f", vf);
        printf("\n");
        break;
    case 3:
        printf("\nEnTRE COM AS IMFORMACAO:");
        printf("\nCapital(VP): ");
        scanf("%f", &vp);
        printf("\nTaxa(i%%): ");
        scanf("%f", &i);
        ...
        scanf("%f", &n);
        j = vp * (i / 100.0) * n;
        printf("\nO resultado do valor dos juros(J) eh:  R$%.2f", j);
        printf("\n");
        break;
    case 4:
        ...
        scanf("%f", &n);
        i = (vf / vp - 1.0) / n;
        printf("\nA taxa dessa aplicacao eh equivalente a %.2f%% ao mes", i * 100);
        printf("\n");
        break;
    case 5:
        printf("\nEntre com as Informacao:");
        printf("\nMontante(VF): ");
        scanf("%f", &vf);
        printf("\nCapital(VP): ");
        scanf("%f", &vp);
        ...
        i = converter_taxa_simples(i, tempo);
        n = ((vf / vp) - 1.0) / (i / 100.0);
        printf("\nO resultado do valor do tempo(N) eh %.0f meses", n);
        printf("\n");
        break;
    default:
        printf("\nERRO ! Retornando ao menu...");
        printf("\n");
    }
}
...
void capitalizacao_composta()
{
    ...
    case 2:
        ...
        scanf("%f", &n);
        vf = vp * pow((1.0 + i), n);
        printf("\nO montante dessa aplicação eh R$%.2f", vf);
        printf("\n");
        break;
    case 3:
        ...
        printf("\nO juros dessa aplicação eh R$%.2f", j);
        printf("\n");
        break;
    case 4:
        ...
        printf("\nA taxa dessa aplicacao eh %.2f%% ao mes", i * 100);
        printf("\n");
        break;
    case 5:
        ...
        den = 1 + i;
        n = log(num) / log(den);
        printf("\nO tempo dessa aplicacao eh %.0f meses", n);
        printf("\n");
        break;
    default:
